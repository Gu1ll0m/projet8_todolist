...
Notre fonction devient :  	Controller.prototype.removeItem = function (id) {
                                var self = this;
                                var items;
...
décrire la performance du site => OK
comparaison avec votre application => OK
comment optimiser la performance en vue d'un éventuel "scaling" de votre application => OK
